...
- Winner: {winner} (total score: {winnerScore})
...
1. "Why it won" - A structured, easy-to-read explanation with these sections:
...
export async function POST(request) {
    try {
        const { winner, ranking, weights, scores, options, criteria } = await request.json();
